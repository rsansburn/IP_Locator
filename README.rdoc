...
What was used to develop the application:
  ...
  To develop the application i used the Eclipse (Keplar IDE)
  Also used a SOAP webservice called GeoIPService which I found here: http://www.webservicex.net/ws/WSDetails.aspx?WSID=64
...
How to use:
Simply click the following link: (will be posed soon)
...
First click: http://sqa.fyicenter.com/Online_Test_Tools/Test_IP_Address_Generator.php
Next: Press Start button to generate IP addresses
